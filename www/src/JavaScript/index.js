...
//						document.title = $t + "--" + $height;
	...
	if ($.cookie("loginuser") && $.cookie("loginpass") && $.cookie("loginema")&&login_flag){
		if ($.cookie("loginuser")!="null" && $.cookie("loginpass")!="null" && $.cookie("loginema")!="null") {
			$("#log").html("<p class='l'></p><a href="+"html/enter.html"+"><span>欢迎你"+$.cookie("loginuser")+"</span></a>");
			$("#reg").html("<a></a>");
    ...
    $(".quit").click(function() {
	        ...
	        $.cookie("loginema",null,{ path: '/' });
	       	$("#log").html("<p class='l'>请</p><a href="+"html/enter.html"+"><span>登录<span></a>").find("a").css({"display":"inline-block"});
